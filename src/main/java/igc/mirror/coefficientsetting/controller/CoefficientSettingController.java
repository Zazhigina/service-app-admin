...
public class CoefficientSettingController {
    ...
    public List<OfferCoefficientSetting> findOfferCoefficientsSetting(@RequestBody(required = false) DataFilter<OfferCoefficientsSettingSearchCriteria> filter) {

        return coefficientSettingService.findOfferCoefficientsSetting(filter);
    }
}
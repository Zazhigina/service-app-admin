...
@Component
public class DocumentDeletionTask {
    ...
    public void deleteMarkedDocuments(){
        ...
        webClient
                ...
                .doOnSuccess(success -> log.info("Удаление выполнено успешно"))
                .log()
                .block();

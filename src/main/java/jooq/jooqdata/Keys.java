...
public class Keys {
    ...
    public static final UniqueKey<TCalendarDayRecord> T_CALENDAR_DAY_PK = Internal.createUniqueKey(TCalendarDay.T_CALENDAR_DAY, DSL.name("t_calendar_day_pk"), new TableField[] { TCalendarDay.T_CALENDAR_DAY.ID }, true);
    public static final UniqueKey<TCalendarDayRecord> T_CALENDAR_DAY_UN = Internal.createUniqueKey(TCalendarDay.T_CALENDAR_DAY, DSL.name("t_calendar_day_un"), new TableField[] { TCalendarDay.T_CALENDAR_DAY.DATE }, true);
    ...
    public static final UniqueKey<TFeedbackFileRecord> T_FEEDBACK_FILE_PKEY = Internal.createUniqueKey(TFeedbackFile.T_FEEDBACK_FILE, DSL.name("t_feedback_file_pkey"), new TableField[] { TFeedbackFile.T_FEEDBACK_FILE.UID }, true);

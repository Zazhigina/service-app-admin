...
public class TAnswerVersion extends TableImpl<TAnswerVersionRecord> {
    ...
    /**
     * The column <code>admin.t_answer_version.is_used</code>. Индикатор выбора
     * ответа. Удалить!!!
     */
    public final TableField<TAnswerVersionRecord, Boolean> IS_USED = createField(DSL.name("is_used"), SQLDataType.BOOLEAN, this, "Индикатор выбора ответа. Удалить!!!");
     ...
     */
    public <U> SelectField<U> mapping(Function10<? super Long, ? super Long, ? super String, ? super Integer, ? super LocalDateTime, ? super String, ? super LocalDateTime, ? super String, ? super Boolean, ? super Boolean, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function10<? super Long, ? super Long, ? super String, ? super Integer, ? super LocalDateTime, ? super String, ? super LocalDateTime, ? super String, ? super Boolean, ? super Boolean, ? extends U> from) {

...
-- DROP TABLE "admin".t_cost_range;

CREATE TABLE "admin".t_cost_range (
	id int8 NOT NULL DEFAULT admin.get_id(), -- ID
	lower_bound varchar NOT NULL, -- Нижняя граница
	upper_bound varchar NOT NULL, -- Верхняя граница
	interval_step varchar NOT NULL, -- Шаг Интервала
